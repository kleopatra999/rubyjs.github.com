...
(function() {
  var $args, $exec, $execute, ArgErr, CharTable, Coerce, CoerceProto, RStrProto, method, name, nativeArray, nativeNumber, nativeObject, nativeRegExp, nativeString, root, toString, _ref,
    __slice = [].slice,
  ...
  RubyJS.Kernel = (function() {
    ...
    Kernel.prototype.box = function(obj, recursive, block) {
      ...
      var object_type, primitive_type;
    ...
    Kernel.prototype.equals = function() {
      return this['=='].apply(this, arguments);
    };

    Kernel.prototype.equal_case = function() {
      return this['==='].apply(this, arguments);
    };

    Kernel.prototype.cmp = function() {
      return this['<=>'].apply(this, arguments);
    };

    Kernel.prototype.modulo = function() {
      return this['%'].apply(this, arguments);
    };

    Kernel.prototype.plus = function() {
      return this['+'].apply(this, arguments);
    };

    Kernel.prototype.minus = function() {
      return this['-'].apply(this, arguments);
    };

    Kernel.prototype.multiply = function() {
      return this['*'].apply(this, arguments);
    };

    Kernel.prototype.exp = function() {
      return this['**'].apply(this, arguments);
    };

    Kernel.prototype.divide = function() {
      return this['/'].apply(this, arguments);
    };
  ...
  RubyJS.Base = (function(_super) {
    ...
    Base.prototype.string_to_proc = function(obj) {
      if (R.isFunction(obj)) {
        return obj;
      } else if (RubyJS.String.isString(obj)) {
        return function(_el) {
          return _el[obj]();
        };
      } else {
  ...
  RubyJS.Enumerable = (function() {
    ...
    Enumerable.prototype.each_with_index = function(block) {
      ...
      this.each(function() {
        var val;
        val = block.call(this, $args(arguments), new RubyJS.Fixnum(idx));
        idx += 1;
        return val;
      });
      return this;
  ...
  RubyJS.Enumerator = (function(_super) {
    ...
    Enumerator.prototype.each_with_index = function(block) {
      ...
      return this.each(function() {
        var args, val;
        args = $args(arguments);
        val = block.call(this, args, new RubyJS.Fixnum(idx));
        idx += 1;
        return val;
      });
    };
  ...
  RubyJS.Array = (function(_super) {
    ...
    Array.prototype.append = Array.prototype['<<'];
    ...
    Array.prototype['-'] = Array.prototype.minus;

    Array.prototype['*'] = Array.prototype.multiply;

    Array.prototype['+'] = Array.prototype.plus;

    Array.prototype['|'] = Array.prototype.union;

    Array.prototype.to_s = Array.prototype.inspect;

    Array.prototype.equal_case = Array.prototype['==='];

    Array.prototype.equals = Array.prototype['=='];

    Array.prototype.cmp = Array.prototype['<=>'];
  ...
  RubyJS.Range = (function(_super) {
    ...
    Range.prototype.equal_case = Range.prototype['==='];

    Range.prototype.equals = Range.prototype['=='];

    Range.prototype.cmp = Range.prototype['<=>'];
  ...
  RubyJS.String = (function(_super) {
    ...
    String.prototype.ljust = function(width, padString) {
      ...
      if (this.length >= width) {
        ...
        return this.$String(this + padString.multiply(padLength).to_native().slice(0, padLength));
      }
    };
    ...
    String.prototype.append = String.prototype['<<'];

    String.prototype.equal_case = String.prototype['==='];

    String.prototype.equals = String.prototype['=='];

    String.prototype.cmp = String.prototype['<=>'];

    String.prototype.modulo = String.prototype['%'];

    String.prototype.plus = String.prototype['+'];

    String.prototype.minus = String.prototype['-'];

    String.prototype.multiply = String.prototype['*'];

    String.prototype.divide = String.prototype['/'];
  ...
  RubyJS.Numeric = (function(_super) {
    ...
    Numeric.prototype.coerce = function(other) {
      ...
      } else if (other.__proto__ === this.__proto__) {
  ...
  RubyJS.Fixnum = (function(_super) {
    ...
    Fixnum.prototype.equals = Fixnum.prototype['=='];

    Fixnum.prototype.cmp = Fixnum.prototype['<=>'];

    Fixnum.prototype.modulo = Fixnum.prototype['%'];

    Fixnum.prototype.plus = Fixnum.prototype['+'];

    Fixnum.prototype.minus = Fixnum.prototype['-'];

    Fixnum.prototype.multiply = Fixnum.prototype['*'];

    Fixnum.prototype.divide = Fixnum.prototype['/'];
  ...
  RubyJS.Float = (function(_super) {
    ...
    Float.prototype.equals = Float.prototype['=='];

    Float.prototype.equal_case = Float.prototype['==='];

    Float.prototype.cmp = Float.prototype['<=>'];

    Float.prototype.modulo = Float.prototype['%'];

    Float.prototype.plus = Float.prototype['+'];

    Float.prototype.minus = Float.prototype['-'];

    Float.prototype.multiply = Float.prototype['*'];

    Float.prototype.exp = Float.prototype['**'];

    Float.prototype.divide = Float.prototype['/'];
